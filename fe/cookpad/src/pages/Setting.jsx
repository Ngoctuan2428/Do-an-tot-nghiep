...
export default function Settings() {
  ...
  const items = [
    { label: 'Tài khoản', route: '/settings/account' },
    {
      label: 'Điều chỉnh chức năng thông báo',
      route: '/settings/notifications',
    },
    { label: 'Điều khoản Dịch Vụ và Chính sách', route: '/settings/policy' },
    { label: 'Những câu hỏi thường gặp', route: '/settings/faq' },
    { label: 'Góp Ý', route: '/settings/feedback' },
    {
      label:
        'Tải ứng dụng Cookpad để tham gia cộng đồng nấu ăn tại gia lớn nhất Việt Nam!',
      route: '/download',
    },
    { label: 'Cộng tác với Cookpad', route: '/settings/collaboration' },
  ];
