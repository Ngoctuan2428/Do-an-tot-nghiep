...
export default function LoginPage() {
  ...
  // Hàm xử lý khi click vào nút Google
  const handleGoogleLogin = () => {
    console.log("Đang chuyển hướng đến trang đăng nhập Google...");
    // Thay thế URL này bằng endpoint Google OAuth của backend của bạn
    ...
    >
      <div className="bg-black/70 p-10 rounded-xl shadow-lg w-full max-w-md text-white">
        ...
        <div className="flex justify-center">
          {/* Chỉ giữ lại nút Google */}
          <button 
            onClick={handleGoogleLogin} 
            className="flex items-center justify-center bg-white text-gray-800 py-2 px-4 rounded-md font-semibold hover:bg-gray-100 transition-colors"
          >
            <img
